...
class spi_ctrl_c extends uvm_reg;
  ...
  constraint c_ass { ssa.value == 1'b1; }
  virtual function void build();
    ...
    ssa = uvm_reg_field::type_id::create("ssa");
    ssa.configure(this, 1, 13, "RW", 0, `UVM_REG_DATA_WIDTH'h0>>13, 1, 1, 1);
  endfunction
